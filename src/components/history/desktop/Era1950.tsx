    ...
    return (
        ...
        >
            ...
            <Image
                ...
                width={400}
                height={300}
                className="absolute left-1/2 top-1/3 -translate-x-1/2 -translate-y-1/4 w-[40vw] h-auto object-contain drop-shadow-2xl"
            />

            {/* text */}
            <div
                ref={textRef}
                className="absolute left-1/2 bottom-[12%] -translate-x-1/2 text-center max-w-[46rem] px-8"
            >
